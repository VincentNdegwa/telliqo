...
class LaratrustSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'feedback.manage', 'display_name' => 'Manage Feedback', 'description' => 'Full access to feedback management'],
            ...
            ['name' => 'customer.manage', 'display_name' => 'Manage Customers', 'description' => 'Full access to customer management'],
            ...
            ['name' => 'review-request.manage', 'display_name' => 'Manage Review Requests', 'description' => 'Full access to review requests'],
            ...
            ['name' => 'qr.manage', 'display_name' => 'Manage QR Codes', 'description' => 'Full access to QR code management'],
            ...
            ['name' => 'business-settings.manage', 'display_name' => 'Manage Settings', 'description' => 'Full access to business settings'],
            ...
            ['name' => 'api-integration.manage', 'display_name' => 'Manage API Integration', 'description' => 'Full access to API integration'],
            ...
            ['name' => 'team.user-manage', 'display_name' => 'Manage Team Users', 'description' => 'Full access to team user management'],
            ...
            ['name' => 'team.role-manage', 'display_name' => 'Manage Roles', 'description' => 'Full access to role management'],
